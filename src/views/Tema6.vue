...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-4(data-aos="fade-left")
      ...
      p.mb-4(data-aos="fade-right") En caso de realizar tratamientos con fármacos para la inducción o dilatación, como por ejemplo la oxitocina, se recomienda el uso después del nacimiento de varias crías nunca de la primera. La finalización del parto se produce hasta la eliminación de la placenta.
      p.mb-4(data-aos="fade-right") A continuación, se pueden ver los procedimientos técnicos sobre, pesaje, ordeño, despique y despezuñado:
      ...
      .lineamarilla.mb-4(data-aos="fade-right")
